...
public class FetchSubscriberProfileInteractor {
    private GitHubApi apiClient;

    /**
     * Construct method of FetchSubscriberProfileInteractor that receives a GithubApi reference.
     *
     * @param apiClient GitHubApi reference
     */
    @Inject
    public FetchSubscriberProfileInteractor(GitHubApi apiClient) {
